_base_ = [
    '../../_base_/models/senformer_swin.py', '../../_base_/datasets/cityscapes.py',
...
# By default, models are trained on 8 GPUs with 1 images per GPU or 4 GPUs with 2 images per GPU
